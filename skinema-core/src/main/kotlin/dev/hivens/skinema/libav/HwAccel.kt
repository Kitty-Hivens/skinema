 ...
 * device or codec support is present -- the same fail-soft spirit as the
 * rest of the pipeline. [REQUIRE] turns that fallback into a hard failure:
 * a file that cannot decode on the GPU surfaces as
 * [dev.hivens.skinema.player.VideoPlayer.State.Failed].
 *
